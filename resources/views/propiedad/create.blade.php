                ...
                <div class="card-body">
                    <blockquote class="blockquote mb-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <p class="small font-weight-bold">Los campos marcados con * son obligatorios</p>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-md-4">
                                <div class="input-group mb-2">
                                    <input type="text" name="cve_int_cliente" id="cve_int_cliente" class="form-control form-control-sm" placeholder="CVE INT Cliente">
