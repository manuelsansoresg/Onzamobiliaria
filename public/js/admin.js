...
$(document).ready(function () {
  ...
  var table = $('#table_property_assigment').DataTable({
    ...
    buttons: [{
      ...
      pageSize: 'letter',
      //A3 , A4,A5 , A6 , legal , letter
      pageMargins: [0, 0, 0, 0],
      // try #1 setting margins
      margin: [0, 0, 0, 0],
      // try #2 setting margins                    
...
window.viewMore = function (property_assignment_id) {
  ...
  $('#body_more').html('');
  axios.get('/admin/property_assignment/view_more/' + property_assignment_id).then(function (response) {
...
function getProperties() {
  ...
  axios.get('/admin/property/getAll?filtro=' + filtro + '&campo=' + campo).then(function (response) {
    var result = response.data;
  })["catch"](function (error) {});
}
...
module.exports = __webpack_require__(/*! C:\laragon\www\Onzamobiliaria\resources\js\admin.js */"./resources/js/admin.js");
